    ...
    <div className="pb-24 bg-gray-50 min-h-screen">
      ...
      <header className="bg-white px-4 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm">
        ...
        <div className="relative">
          <Button variant="ghost" size="icon" className="text-red-500" onClick={() => navigate('/profile')}>
      ...
      <div className="mt-8 px-4">
        ...
        {filteredProducts.length === 0 ? (
          <div className="py-12 text-center">
            <p className="text-gray-400 font-medium">No dishes found. Try something else!</p>
          </div>
        ) : (
